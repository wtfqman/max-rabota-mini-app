...
CREATE TABLE "vacancy_details" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "vacancy_details_ad_id_fkey"
...
CREATE TABLE "resume_details" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "resume_details_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "equipment_details" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "equipment_details_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ad_photos" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "ad_photos_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ad_contacts" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "ad_contacts_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "vacancy_metro_stations" (
    ...
    CONSTRAINT "vacancy_metro_stations_vacancy_details_id_fkey"
      FOREIGN KEY ("vacancy_details_id") REFERENCES "vacancy_details" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "vacancy_metro_stations_metro_station_id_fkey"
...
CREATE TABLE "ad_requirements" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "ad_requirements_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ad_responsibilities" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "ad_responsibilities_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "ad_benefits" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "ad_benefits_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "favorites" (
    ...
    CONSTRAINT "favorites_user_id_fkey"
      FOREIGN KEY ("user_id") REFERENCES "users" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "favorites_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "reviews" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "reviews_author_id_fkey"
      FOREIGN KEY ("author_id") REFERENCES "users" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "reviews_subject_id_fkey"
      FOREIGN KEY ("subject_id") REFERENCES "users" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "reviews_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
...
CREATE TABLE "moderation_logs" (
    ...
    "metadata_json" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "moderation_logs_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "moderation_logs_moderator_id_fkey"
...
CREATE TABLE "channel_publish_logs" (
    ...
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "channel_publish_logs_ad_id_fkey"
      FOREIGN KEY ("ad_id") REFERENCES "ads" ("id")
      ON DELETE CASCADE ON UPDATE CASCADE
);
